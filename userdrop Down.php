...
<div class="row page-row">
	<main lass="main" style="padding-left: 15px;">
					...
					<div class="tracking">
						<div class="row">
							<div class="col-sm-12">
								...
								<p><span class="d-block">Enhanced the UI of the user dropdown</p>
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="blue-card" style="width: 100%; display: inline-block; background: #83E58D ;">
									<img src="assets/UI Designs/User Dropdown 00.png" width="300" height="auto" alt="User drop down" />
								</div>
							</div>
						</div>
					</div>
		...
		<!-- User dropdown redesign start here -->
			...
			<div class="row g-4">
				...
				<div class="col-sm-8">
					<div class="text-content">
						<h4>User drop down</h4>
						<h3>A users own dropdown pannel</h3>
						...
						<p>They have outdated user dropdown. I was tasked with redesigning the dropdown.</p>
						<div class="massive-wrapper">
							<img src="assets/UI Designs/Perivious Dropdown.png" class="img-fluid" width="400" height="auto" alt="Ols User drop down">
							<span class="img-caption">Previous User drop down</span>
						</div>
					</div>
				</div>
			</div>
		</section>
		<!-- User drop down section end here -->

		<!-- New user dropdown section start here -->
		<section class="development">
			<div class="row g-5">
				...
				<div class="col-sm-8">
					<div class="text-content">
						<h4>New User Dropdown</h4>
						<h3>Have a look at the Redesigned user dropdown.</h3>
					</div>
				</div>
				<div class="col-12">
					<div class="full-screen-layout text-center">
						<img src="assets/UI Designs /User Dropdown 00.png"  alt="new user dropdown">
					</div>
				</div>
			</div>
		</section>
		<!-- New user dropdown section end here -->


			<!-- Change Password Figma File section start here 
			<section class="development padding-y prototype-section">
				<div class="row">
					...
					<div class="col-md-8">
						<div class="prototype-content">
							<h2>View Site</h2>
							<h3>Figma File </h3>
							<span>Change Password Figma File</span>
							<a href="https://www.figma.com/design/5WRRZps7wD8Ols6blncsZy/Change-Password-(R)?node-id=0-1&t=AEHUplrOHQRTPWCJ-1" target="_Blank" class="btn button-common">View Figma File</a>
							<br>
                                            </div>
					</div>
			 ...
			 Change Password Figma File section end here -->
