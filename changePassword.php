...
<div class="row page-row">
	<main lass="main" style="padding-left: 15px;">
					...
					<div class="tracking">
						<div class="row">
							<div class="col-sm-12">
								...
								<p><span class="d-block">Designed a change Password Page.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="blue-card" style="width: 100%; display: inline-block;">
									<img src="assets/UI Designs/change_password.png" width="480" height="auto" alt="Change Passwords page" />
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row g-4">
				...
				<div class="col-sm-8">
					<div class="text-content">
						...
						<p>They have outdated change password page. I was tasked with redesigning the page.</p>
						<div class="massive-wrapper">
							<img src="assets/images/image/changePassword.svg" class="img-fluid" alt="img-fluid">
							<span class="img-caption">Previous Change Password Page</span>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- New Change Password Page section start here -->
		<section class="development">
			<div class="row g-5">
				...
				<div class="col-sm-8">
					<div class="text-content">
						<h4>New Change Password Page</h4>
						<h3>Have a look at the Redesigned Change Password Page.</h3>
					</div>
				</div>
				<div class="col-12">
					<div class="full-screen-layout text-center">
						<img src="assets/images/image/new-change-password.svg" class="img-fluid" alt="new change password">
					</div>
				</div>
			</div>
		</section>
		<!-- New Change Password Page section end here -->
