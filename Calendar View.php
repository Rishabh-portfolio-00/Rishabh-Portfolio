	...
	<main lass="main" style="padding-left: 15px;">
					...
					<div class="tracking">
						<div class="row">
							<div class="col-sm-12">
								<h4>UI Designs</h4>
								<h3>Calendar View</h3>
								<p><span class="d-block">Designed a a calendar view.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="blue-card" style="width: 100%; display: inline-block; background:#E09EED;">
									<img src="assets/UI Designs/Calendar View.png" width="480" height="auto" alt="Calendar View" />
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row g-4">
				...
				<div class="col-sm-8">
					<div class="text-content">
						<h4>Calendar View</h4>
						<h3>An holistic view of the month</h3>
						...
						<p>There was no calendar view available for the product, hence we needed to design an calendar view were, the person can view the entire month activity at once.</p>
						
					</div>
				</div>
			</div>
		</section>
		<!-- calendar view end here -->

		<!-- New Calendar View section start here -->
		<section class="development">
			<div class="row g-5">
				...
				<div class="col-sm-8">
					<div class="text-content">
						<h4>New Calendar view</h4>
						<h3>Have a look at the Redesigned New Calendar view.</h3>
					</div>
				</div>
				<div class="col-12">
					<div class="full-screen-layout text-center">
						<img src="assets/UI Designs/Calendar View.png" class="img-fluid" alt="new calendar design">
					</div>
				</div>
			</div>
		</section>
		<!-- New calendar view section end here -->
